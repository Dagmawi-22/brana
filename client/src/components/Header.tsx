  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-between mb-8 px-4">
      ...
      <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-x-4 sm:space-y-0">
        <button
          className="w-full cursor-pointer sm:w-auto px-6 py-3 sm:px-4 sm:py-3 bg-blue-500 text-white rounded-full shadow-lg hover:bg-blue-600 transition-all"
        ...
        <button
          className="cursor-pointer w-full sm:w-auto px-6 py-3 sm:px-4 sm:py-3 bg-red-500 text-white rounded-full shadow-lg hover:bg-red-600 transition-all"
